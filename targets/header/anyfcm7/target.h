...
//LEDS
#define LED_NUMBER 2
#define LED1PIN Pin_PIN_B6
#define LED2PIN Pin_PIN_B9
...
#define MOTOR_PIN4 MOTOR_PIN_PA1
#define MOTOR_PIN5 MOTOR_PIN_PB0
#define MOTOR_PIN6 MOTOR_PIN_PB5
#define MOTOR_PIN7 MOTOR_PIN_PA0
